...
class Admin_Users_Accesses_Model extends Model {

    protected $table = 'admin_users_accesses';
    public $primary_key;
    public $data;
    protected $allowedFields    = ['user_id' , 'menuitem_id', 'add_permission', 'edit_permission', 'delete_permission'];
