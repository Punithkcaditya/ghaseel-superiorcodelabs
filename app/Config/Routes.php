...
$routes->get('/upload', 'Ajaxupload::index');
$routes->match(['post'], '/load', 'Ajaxupload::upload');
...
$routes->match(['post'], '/depedentselect', 'Home::depedentselect');
...
$routes->group('Main', ['filter'=>'authenticate'], static function($routes){
    ...
    $routes->match(['post'], 'addCity', 'Main::addCity');
