...
use App\Models\Department as Designation_Model;
class Auth extends BaseController
{
    ...
    public function __construct()
    {
        ...
        $this->emp_model = new Employee_Model;
        $this->desg_model = new Designation_Model;
    }
    ...
    {   
        ...
        if($this->request->getMethod() == 'post'){
            ...
            // $email = $this->emp_model->where('email', $this->request->getPost('email'))->first();
            // foreach($email as $k => $v){
            //     if($v=='department_id')
            //     $dept_id = $this->desg_model->where('id', $v)->first();
            // }
        ...
        return view('auth/logintwo', $data);
    }
    ...
    public function register(){
        ...
        return view('auth/registertwo', $data);
    }
