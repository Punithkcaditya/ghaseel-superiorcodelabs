...
class Addcompany extends BaseController
{
    ...
    public function index()
    {
        ...
        $data['menuslinks'] = $this
            ...
            ->uri
            ->getSegment(1);
        return view('Modules\Admin\Views\pages\company\companylist', $data);
    }
    ...
    public function addNewCompany()
    {
        ...
        $data['menuslinks'] = $this
            ...
            ->uri
            ->getSegment(1);
        return view('Modules\Admin\Views\pages\company\addnewcompany', $data);
    ...
    public function savenewcompany()
    {
        ...
        $input = $this->validate(['first_name' => 'required|min_length[3]', 'email' => 'required|valid_email', 'phone_number' => 'required|numeric|regex_match[/^[0-9]{10}$/]', 'status_ind' => 'required', 'role_id' => 'required', 'customer_location_id' => 'required', 'services' => 'required']);
                    ...
                    else
                    {
                        ...
                        else
                        {
                            ...
                            $update = $this
                                ...
                                if (!empty($update)) {
                                        $delete = $this->services_model->where('company_id', $company_id_hidd)->delete();
                                        if ($delete) {
                                                $services_array = [];
                                                ...
                                                foreach ($new_array as $servicesind)
                                                {
                    
                                                    $services_array = ['Services' => $servicesind, 'company_id' => $company_id_hidd, 'status_ind' => 1, 'created_date' => date('Y-m-d') , 'added_by' => $pot[0]['user_id']
                    ...
                    else
                    {
                        ...
                        if ($save)
                        {
                            ...
                            foreach ($new_array as $servicesind)
                            {
                                ...
                                $services_array = ['Services' => $servicesind, 'company_id' => $save, 'status_ind' => 1, 'created_date' => date('Y-m-d') , 'added_by' => $pot[0]['user_id']
