					...
					<div class="container-fluid pt-8">
						<div class="page-header mt-0 shadow p-3">
							...
							<div class="btn-group mb-0">
								<a href="<?php echo base_url(); ?>/addNewCompanyList">
											...
											<table id="example" class="table table-striped table-bordered w-100 text-nowrap">
												<thead>
													<tr>
														...
														<th class="wd-15p">Campany Name</th>
														<th class="wd-15p">Services</th>
														<th class="wd-15p" style="text-align: center;" >Thumbnail</th>
												...
												<tbody>
													...
													?>
													<?php foreach ($company as $key => $sid) : ?>
													
														<tr>
															<th><?= $i++ ?></th>
															<td><?= $sid->company_name  ?></td>
															<td><?= $sid->differentservices ?></td>
															<td style="text-align: center;"> <img style="width: 139px;" id="blah" src="<?= base_url("uploads/" . $sid->profile_pic) ?>" /> </td>
															
															<td>

																<a href="<?= base_url('edit_company/' . $sid->company_user_id ) ?>" class="mx-2 text-decoration-none text-primary"><i class="fa fa-edit"></i></a>

																<a href="<?= base_url('delete_company/' .  $sid->company_user_id ) ?>" class="mx-2 text-decoration-none text-danger" onclick="if(confirm('Are you sure to delete  - <?= $sid->company_name  ?> from list?') !== true) event.preventDefault()"><i class="fa fa-trash"></i></a>
															</td>
														</tr>
													<?php endforeach; ?>
