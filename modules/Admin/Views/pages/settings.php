                                ...
                                <div class="card shadow">
                                    ...
                                    <div class="card-body">
                                        <div class="table-responsives">
                                            ...
                                            <form id="user_form" name="user_form" action="<?= base_url('settingsupdate') ?>" method="POST" enctype="multipart/form-data">
                                                        ...
                                                        <div class="col-md-12">
                                                            <div class="form-group">
                                                                ...
                                                                <?php if ($row->type == 'textarea') : ?>
                                                                    <textarea class="form-control" name="setting_value[<?php echo $row->setting_id; ?>]" placeholder="<?php echo $row->setting_name; ?>"><?php echo $row->setting_value; ?></textarea>
                                                                ...
                                                                <?php elseif ($row->type == 'checkbox') : ?>
                                                                    <input name="setting_value[<?php echo $row->setting_id; ?>]" value="1" type="checkbox" <?php echo (!empty($row->setting_value) && $row->setting_value == 1) ? 'checked' : ''; ?> />
