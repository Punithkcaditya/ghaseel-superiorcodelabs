					...
					<div class="container-fluid pt-8">
						<div class="page-header mt-0 shadow p-3">
							...
							<div class="btn-group mb-0">
								<a href="<?php echo base_url(); ?>/addNewCity">
										...
										<div class="table-responsive">
											...
											<table id="example" class="table table-striped table-bordered w-100 text-nowrap">
												...
												<tbody>
													...
													?>
													<?php foreach ($cities as $key => $sid) : ?>
													
														<tr>
															<th><?= $i++ ?></th>
															<td><?= $sid->city_name ?></td>
															<td><?= $sid->differentlocations ?></td>
															<td>
															...
															<td>
																...
																<a href="<?= base_url('city_edit/' . $sid->id) ?>" class="mx-2 text-decoration-none text-primary"><i class="fa fa-edit"></i></a>

																<a href="<?= base_url('city_delete/' . $sid->id) ?>" class="mx-2 text-decoration-none text-danger" onclick="if(confirm('Are you sure to delete  - <?= $sid->city_name ?> from list?') !== true) event.preventDefault()"><i class="fa fa-trash"></i></a>
															</td>
														</tr>
													<?php endforeach; ?>
