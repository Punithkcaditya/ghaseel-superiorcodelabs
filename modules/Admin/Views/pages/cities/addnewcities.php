                                ...
                                <div class="card shadow">
                                    ...
                                    <div class="card-body">
                                        <div class="table-responsives">
                                            <form action="<?= base_url('addnewcities') ?>" method="POST">
                                                <div class="row">

                                                    <div class="col-md-12">
                                                        <div class="card shadow">
                                                            <div class="card-header">
                                                                <h2 class="mb-0"><?= $pade_title2 ?></h2>
                                                            </div>
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-md-12">
                                                                        <div class="form-group">
                                                                            ...
                                                                            $i = 1; ?>
                                                                            <input type="hidden" name="city_id_hidd" id="city_id_hidd" value="<?php echo (!empty($query[0]->id)) ? $query[0]->id : "" ?>" />
                                                                            <input type="text" class="form-control" name="city_name" id="city_name" placeholder="Enter City Name" value="<?= !empty($query[0]->city_name) ? $query[0]->city_name : '' ?>">
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="card shadow" style="padding-bottom: 74px;">
                                                                                ...
                                                                                <div class="table-responsive">
                                                                                    <table class="table card-table table-vcenter text-nowrap  align-items-center">
                                                                                        <thead class="thead-light">
                                                                                            <tr>
                                                                                                <th><input class='check_all' type='checkbox' onclick="select_all()" /> Select All</th>
                                                                                                <th>S. No</th>
                                                                                                <th></th>
                                                                                                <th></th>
                                                                                            </tr>
                                                                                        ...
                                                                                        <tbody>
                                                                                        <?php if ( !empty($query[0]->locations_name)){ 
                                                                                            $k=0; $p=1;
                                                                                            $fraction = count($query)/2;
                                                                                            for ($j=1; $j <= round( $fraction) ; $j++) {  ?>

                                                                                                            <tr>
                                                                                                            <td><input type='checkbox' class='case'/></td>
                                                                                                            <td><span id='snum'><?= $j ?>.</span></td>
                                                                                                            <td> <input type='text' class="form-control" placeholder="Enter Location" id='location<?= $p++ ?>' name='location[]'  value="<?= !empty($query[$k]->locations_name) ? $query[$k++]->locations_name : '' ?>"/></td>

                                                                                                            <td><input type="text" class="form-control  state-valid" placeholder="Enter Location" id='location<?= $p++ ?>' name="location[]" value="<?= !empty($query[$k]->locations_name) ? $query[$k++]->locations_name : '' ?>"></td>
                                                                                            ...
                                                                                            <tr>
                                                                                                ...
                                                                                                <td> <input type='text' class="form-control" placeholder="Enter Location" id='location<?= $i++ ?>' name='location[]'/></td>

                                                                                                <td><input type="text" class="form-control  state-valid" placeholder="Enter Location" id='location<?= $i++ ?>' name="location[]"></td>
                                                            ...
                                                            <div class="col-md-12 button_holder">
                                                                <div class="card-body">
                                                                    ...
                                                                    <button type="button" class="btn btn-info mt-1 mb-1" id="addmore"><i class="fas fa-plus-circle"></i> Add Fields</button>
                                                                    <button type="button" class="btn hideing btn-danger mt-1 mb-1" id="delete"><i class="fas fa-minus"></i> Delete Fields</button>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
