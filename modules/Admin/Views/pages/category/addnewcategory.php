        ...
        <aside class="app-sidebar ">
            ...
            <div class="sidebar-img">
                ...
                <ul class="side-menu">
                    ...
                    <li <?php if (strtolower($main_menus->menuitem_link) == strtolower($menuslinks))
        { ?>class="active slide" <?php
        }
        else
        { ?>class="slide" <?php
        } ?>>
                                ...
                                <div class="card shadow">
                                    ...
                                    <div class="card-body">
                                        <div class="table-responsives">
                                            <form action="<?=base_url('savenewcategories') ?>" method="POST"
...
$i = 1; ?>
                                                                        <label for="formGroupExampleInput"><?=$pade_title
?></label>
                                                                        <input type="hidden" name="category_id_hidd"
                                                                            id="category_id_hidd"
                                                                            value="<?php echo (!empty($query[0]->id)) ? $query[0]->id : "" ?>" />
                                                                        <input type="text" class="form-control"
                                                                            name="category_name" id="category_name"
                                                                            placeholder="Enter Category Name"
                                                                            value="<?=!empty($query[0]->category_name) ? $query[0]->category_name : '' ?>">
                                                                    ...
                                                                    <div class="form-group col-md-12">
                                                                        ...
                                                                        <?php if (!empty($query[0]->category_image))
{ ?>

                                                                        <img style="width: 139px;" id="blah"
                                                                            src="<?=base_url("uploads/" . $query[0]->category_image) ?>" />
                                                                        <?php
}
else
{ ?>
                                                                    ...
                                                                    <div class="form-group col-md-12">
                                                                        <label for="formGroupExampleInput"><?=$title2
?></label>
                                                                        <input type="file" name="file"
                                                                            class="form-control" id="file"
                                                                            onchange="showPreviewcategory(event);"
                                                                            accept=".png, .jpg, .jpeg" />
                                                                    </div>


                                                                    <div class="form-group  col-md-12">
                                                                        <label for="formGroupExampleInput"><?=$title3
?></label>
                                                                        <textarea class="form-control" cols="20"
                                                                            rows="4" name="category_description"
                                                                            id="category_description"
                                                                            maxlength="140"><?php echo htmlspecialchars(!empty($query[0]->category_description) ? $query[0]->category_description : ''); ?></textarea>
                                                                    </div>
