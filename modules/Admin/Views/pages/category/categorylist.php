												...
												<tbody>
													...
													<?php foreach ($category as $row) : ?>
														...
														<tr>
															...
															<td style="text-align: center;"> <img style="width: 139px;" id="blah" src="<?= base_url("uploads/" . $row['category_image']) ?>" /> </td>
															
															<td>

																<a href="<?= base_url('category_edit/' . $row['id'] ) ?>" class="mx-2 text-decoration-none text-primary"><i class="fa fa-edit"></i></a>

																<a href="<?= base_url('category_delete/' .  $row['id']) ?>" class="mx-2 text-decoration-none text-danger" onclick="if(confirm('Are you sure to delete  - <?= $row['category_name']  ?> from list?') !== true) event.preventDefault()"><i class="fa fa-trash"></i></a>
															</td>
														</tr>
													<?php endforeach; ?>
