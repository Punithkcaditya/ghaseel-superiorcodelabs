                                ...
                                <div class="card shadow">
                                    ...
                                    <div class="card-body">
                                        <div class="table-responsives">
                                            <form id="user_form" name="user_form" action="<?= base_url('formstore') ?>" method="POST" enctype="multipart/form-data">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        ...
                                                        <input type="hidden" name="car_id_hidd" id="car_id_hidd" value="<?php echo (!empty($query[0]->id)) ? $query[0]->id : "" ?>" />
                                                        <div class="form-group">

                                                            <label class="form-label">CAR NAME</label>
                                                            <input type="text" class="form-control" name="vehicle_name" id="vehicle_name" placeholder="Enter car Name" value="<?= !empty($query[0]->vehicle_name) ? $query[0]->vehicle_name : '' ?>">
                                                        </div>
                                                    </div>
