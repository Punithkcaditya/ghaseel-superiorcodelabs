											...
											<table id="example" class="table table-striped table-bordered w-100 text-nowrap">
												<thead>
													<tr>
														...
														<th style="text-align: center;" class="wd-20p">Thumbnail</th>
													...
													<?php foreach ($cars as $row) : ?>
														<tr>
															...
															<td>
																...
																<a href="<?= base_url('vehicle_delete/' . $row['id']) ?>" class="mx-2 text-decoration-none text-danger" onclick="if(confirm('Are you sure to delete  - <?= $row['vehicle_name'] ?> from list?') !== true) event.preventDefault()"><i class="fa fa-trash"></i></a>
															</td>
														</tr>
													<?php endforeach; ?>
													<?php if (count($cars) <= 0) : ?>
