					...
					<div class="container-fluid pt-8">
						<div class="page-header mt-0 shadow p-3">
							...
							<div class="btn-group mb-0">
								<a href="<?php echo base_url(); ?>/servicelistwo">
											...
											<table id="example" class="table table-striped table-bordered w-100 text-nowrap">
												<thead>
													<tr>
														...
														<th class="wd-15p">Service Description</th>
														...
														<tr>
															...
															<?php } else { 
																...
																<td><?= $row['company_name'] ?></td>
																 <?php  } endforeach; }?>
															<td><?= $sid->addservicesdescription ?></td>
															...
															<td>
																...
																<a href="<?= base_url('edit_service/' . $sid->id) ?>" class="mx-2 text-decoration-none text-primary"><i class="fa fa-edit"></i></a>

																<a href="<?= base_url('delete_service/' . $sid->id) ?>" class="mx-2 text-decoration-none text-danger" onclick="if(confirm('Are you sure to delete  - <?= $sid->Services ?> from list?') !== true) event.preventDefault()"><i class="fa fa-trash"></i></a>
															</td>
														</tr>
													<?php endforeach; ?>
