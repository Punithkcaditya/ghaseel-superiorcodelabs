                                ...
                                <div class="card shadow">
                                    ...
                                    <div class="card-body">
                                        <div class="table-responsives">
                                            <form action="<?= base_url('savenewserviceinfo') ?>" method="POST"
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-md-12">
                                                                        ...
                                                                        <div class="form-group">
                                                                            <input type="hidden" name="service_id_hidd"
                                                                                id="service_id_hidd"
                                                                            ...
                                                                            <input type="text" class="form-control"
                                                                                ...
                                                                                value="<?= !empty($query[0]->Services) ? $query[0]->Services : '' ?>">
                                                                        </div>
                                                                        ...
                                                                        <div class="form-group">
                                                                            <label
                                                                                class="form-label"><?= "Enter Duration" ?></label>
                                                                        ...
                                                                        <div class="form-group">
                                                                            <label class="form-label">Choose Company
                                                                                Status</label>
                                                                            <select name="status_ind" id="status_ind"
                                                                                class="form-control">
                                                                                <option value="">-- Company Status --
                                                                                </option>
                                                                        ...
                                                                        <div class="form-group">
                                                                            ...
                                                                            <textarea id="editor1"
                                                                                name="editor1"><?php echo htmlspecialchars(!empty($query[0]->addservicesdescription) ? $query[0]->addservicesdescription : ''); ?></textarea>
                                                                        </div>
