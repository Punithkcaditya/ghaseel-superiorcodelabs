    ...
    <div class="page-content">
        ...
        <div class="page-title page-title-small nobackdrnd">
            ...
            <div class="location_show">
                <h2><a href="#" class="navigate" data-menu="menu-success-1" href="#" id="show-bottom"><?= !empty(get_cookie("location")) ? get_cookie("location") : 'Location' ?>
                ...
                if (!empty($cities)) :
                    ...
                    foreach ($cities as $main_menus) : ?>
                        <div class="mb-0">
                            ...
                            <div id="collapse<?= $i
                                                ?>" class="collapse" data-bs-parent="#accordion-1">
        ...
        <div class="row text-center mb-0">
            ...
            if (!empty($cars)) :
                ...
                foreach ($cars as $main_menus) : ?>
                    ...
                    <a href="<?php echo site_url('/brands') ?>" class="col-6 <?= check($i) ? 'ps-2' : 'pe-2' ?>">
                        <div class="card card-style <?= check($i) ? 'ms-0' : 'me-0' ?> mb-3">
                            <h1 class="center-text pt-4 mt-2">
                                <img src="<?= base_url("uploads/" . $main_menus['name']) ?>" alt="<?= $main_menus['vehicle_name'] ?>" />
                            </h1>
