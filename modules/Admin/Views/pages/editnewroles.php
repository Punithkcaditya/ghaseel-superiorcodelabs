                            ...
                            <div class="col-md-12">
                                <div class="card shadow">
                                    <div class="card-header">
                                        <h2 class="mb-0">Add New Roles</h2>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <input type="hidden" name="user_id_hidd" value="<?php echo (!empty($query[0]->role_id)) ? $query[0]->role_id : "" ?>"/>
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" name="role_name" id="role_name" placeholder="Enter First Name" value="<?= !empty($query[0]->role_name) ? $query[0]->role_name : '' ?>">
                                                        </div>
