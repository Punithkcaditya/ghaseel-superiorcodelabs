					...
					<div class="container-fluid pt-8">
						<div class="page-header mt-0 shadow p-3">
							...
							<div class="btn-group mb-0">
								<a href="<?php echo base_url(); ?>/addNewCompany">
													...
													<?php foreach ($company as $key => $sid) : ?>
														...
														<tr>
															...
															<td>
																...
																<a href="<?= base_url('company_edit/' . $sid->company_user_id ) ?>" class="mx-2 text-decoration-none text-primary"><i class="fa fa-edit"></i></a>

																<a href="<?= base_url('company_delete/' .  $sid->company_user_id ) ?>" class="mx-2 text-decoration-none text-danger" onclick="if(confirm('Are you sure to delete  - <?= $sid->company_name  ?> from list?') !== true) event.preventDefault()"><i class="fa fa-trash"></i></a>
															</td>
														</tr>
													<?php endforeach; ?>
