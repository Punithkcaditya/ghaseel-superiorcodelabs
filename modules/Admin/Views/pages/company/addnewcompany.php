                                ...
                                <div class="card shadow">
                                    ...
                                    <div class="card-body">
                                        <div class="table-responsives">
                                            <form action="<?= base_url('savenewcompany') ?>" method="POST"  enctype="multipart/form-data">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <select name="role_id" id="role_id" class="form-control">
                                                                ...
                                                                <option value="<?php echo $row['role_id'] ?>"
                                                                    <?php echo (!empty($query[0]->role_id) && $query[0]->role_id == $row['role_id']) ? 'selected' : '' ?>>
...
// AJAX request
$.ajax({
url:'<?=base_url()?>/depedentselecttwo',
method: 'POST',
data: {city: city},
dataType: 'JSON',
